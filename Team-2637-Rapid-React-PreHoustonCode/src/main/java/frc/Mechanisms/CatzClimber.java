...
{
    public boolean climbDataCollectionOn = true;
    ...
    public CatzClimber()
    {
        ...
        ***********************************************/
        ...
        extendArmEncoderRT.setPosition(0.0);
        ...
        extendArmEncoderLT.setPosition(0.0);
    ...
    *---------------------------------------------------------------------------------------------*/
    ...
    {
        SmartDashboard.putNumber("Left Arm Position", extendArmEncoderLT.getPosition());
        SmartDashboard.putNumber("Left Arm Temp", leftExtendingArmMtr.getMotorTemperature());

        SmartDashboard.putNumber("Right Arm Position", extendArmEncoderRT.getPosition());
